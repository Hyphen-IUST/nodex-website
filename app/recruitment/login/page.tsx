...
export default function RecruitmentLoginPage() {
  ...
  const checkExistingAuth = async () => {
    try {
      ...
      if (data.authenticated) {
        // User is already authenticated, redirect to recruitment dashboard
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        // Login successful, redirect to recruitment dashboard
        router.push("/recruitment");
      } else {
        // Login failed
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Enter your authentication key to access the recruitment dashboard
            </p>
          </div>
